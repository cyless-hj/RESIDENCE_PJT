...
- 각 요소 별 위치정보 유형
	...
	- 법정동 행정동 변환 : DS 측 모델링 행정동 기준, 동코드 맵핑을 통해 변환
...
## 4. 프로젝트 수행 결과 – 웹 서비스
- URL : https://www.dongnae-residence.cf/
### 4-1. 구조
- 프로젝트 내에 두 개의 앱을 생성하여 기능을 구분
	- account : 로그인 관련 기능
	- recommend_app : 그 외의 웹 기능 구현, 내부에 DS 모델링 코드가 모듈화 되어 있는 구조

<p align="center">
	<img src="https://user-images.githubusercontent.com/75618206/204579605-9438241d-96af-4144-af84-7279d4cdf9fc.png">
</p>

### 4-2. 시각화
1. chart.js : 통계자료 그래프를 표현에 사용
...
- 수집된 로그데이터를 활용해 더 개인화된 맞춤형 서비스 제공
