...
class HighShcTransformer:
    ...
    def transform(cls):
        df = spark_session().read.format("csv") \
                                 ...
                                 .csv("s3a://residencebucket/raw_data/HIGH_SCHOOL/HIGHSCHOOL.csv")
        #주소 반환 안된 값 넣어주기
        df_spark=df.select('HIGH_SCH_NAME','ADD_OLD','ADD_STR','LAT','LON')                 
        # df_spark=df_spark.replace(['서울특별시？구로구？개봉동 273-16','서울특별시 강남구 동 617','서울특별시 강남구 동 736'
        # , '서울특별시 강남구 동 712','서울특별시 강남구 동 691', '서울특별시 강남구 동 692', '서울특별시 강남구 동 738','서울특별시 강남구 동 618'
        # ,'서울특별시 강남구 동 714']
        # ,['서울특별시 구로구 개봉동 273-16','서울특별시 강남구 일원동 617','서울특별시 강남구 일원동 736','서울특별시 강남구 일원동 712'
        # ,'서울특별시 강남구 일원동 691','서울특별시 강남구 일원동 692','서울특별시 강남구 일원동 738','서울특별시 강남구 일원동 618','서울특별시 강남구 일원동 714']
        #             , 'ADD_OLD')
        ...
        #category 추가
        df5=df4.withColumn('CATE_CODE',lit("G114"))
        ...
        df6 = df6.drop(df6.SI_DO_CODE) \
                         ...
                         .drop(df6.ADD_OLD)
        df6.show()
        save_data(DataWarehouse, df6, 'HIGH_SCHOOL')
