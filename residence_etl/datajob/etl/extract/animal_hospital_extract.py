...
class AnimalHospitalExtractor:

    URL = 'http://openapi.seoul.go.kr:8088/79504a72666a686a3931414b6b7059/json/LOCALDATA_020301'
    START_IDX = '1'
    END_INDEX = '1000'
    BUCKET_NAME = 'residencebucket'
    FILE_DIR = 'raw_data/ANIMAL_HSPT/ANIMAL_HSPT_' + std_day() + '_'
    ...
    def _generate_page_len(cls, data_dict):
        data_len = data_dict['LOCALDATA_020301']['list_total_count']
        n = data_len // 1000 + 1
        return n
