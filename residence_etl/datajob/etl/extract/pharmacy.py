...
class PharmacyExtractor:
    ...
    URL = 'http://openapi.seoul.go.kr:8088/79504a72666a686a3931414b6b7059/json/TbPharmacyOperateInfo'
    START_IDX = '1'
    END_INDEX = '1000'
    BUCKET_NAME = 'residencebucket'
    FILE_DIR = 'raw_data/PHARMACY/PHARMACY_' + std_day() + '_'
    ...
    def _generate_page_len(cls, data_dict):
        data_len = data_dict['TbPharmacyOperateInfo']['list_total_count']
        n = data_len // 1000 + 1
        return n
